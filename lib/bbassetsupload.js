...
$(function(){
  console.log( "[BBAssetsUpload] BBAssetsUpload::Loading ..." );
  ...
  BBAssetsUpload = function( opts ){
    console.debug( "[BBAssetsUpload] BBAssetsUpload::Initializing with opts", opts );
  ...
  BBAssetsUpload.Backbone.Asset = Backbone.Model.extend({
    ...
    upload: function() {
      console.debug( "[BBAssetsUpload] Uploading file: " + this.get( "file" ).name );
    ...
    onSuccess: function( event ){
      console.debug( "[BBAssetsUpload] File uploaded: " + this.get( "file" ).name );
      var opts = _.extend( event, { "state": "completed" } );
      this.set( opts );
    },

    onError: function( event ){
      this.trigger( "bbassetsupload:asset:upload:error" );
      console.error( "onError uploading file: " + this.get( "file" ).name, event );
    }
  });
  ...
  console.log( "[BBAssetsUpload] ... BBAssetsUpload::Loaded" );
});
