...
((function(...args) {
  ...
  _.size = obj => _.isArray(obj) ? obj.length : _.keys(obj).length;
  ...
  _.first = _.head = _.take = (array, n, guard) => (n != null) && !guard ? slice.call(array, 0, n) : array[0];
  ...
  var unescape = code => code.replace(unescaper, (match, escape) => escapes[escape]);
