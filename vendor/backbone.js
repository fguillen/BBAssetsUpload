...
(function(){
  ...
  Backbone.wrapError = (onError, originalModel, options) => (model, resp) => {
  ...
  var inherits = (parent, protoProps, staticProps) => {
    ...
    if (protoProps && protoProps.hasOwnProperty('constructor')) {
      ...
      child = function(...args) { parent.apply(this, args); };
    }
